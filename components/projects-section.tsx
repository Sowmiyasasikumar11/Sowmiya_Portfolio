...
export function ProjectsSection() {
  return (
    <section id="projects" className="py-24 sm:py-36 relative bg-card/25">
      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-16 relative z-10">
        ...
        >
          <span className="text-primary text-lg font-semibold tracking-widest uppercase">Projects</span>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mt-3 mb-6">Featured Work</h2>
